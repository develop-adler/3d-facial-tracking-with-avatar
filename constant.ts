...
export const COLOR = {
  ...
  systemWarningDark: "#BF8900",
  systemWarningDark2: "#7D5A00",
  systemError: "#FF0000",
  systemInfo: "#1700FF",
  systemTag: "#00376B",
  kakao: "#FFE812",
...
export const AVATAR_CONTROLLER_PARAMS = {
  ...
  RUN_SPEED: 6.5,
  JUMP_FORCE: 12,
  FOV_FIRSTPERSON_MOBILE: 90,
  FOV_FIRSTPERSON: 70,
  FOV_THIRDPERSON_MOBILE: 70,
  FOV_THIRDPERSON: 45,
...
export const STUDIO_OBJECT_TYPE_DICTIONARY: Record<StudioObjectSubType, StudioObjectType3D> = {
  ceiling: 'decoration',
  window: 'decoration',
  lighting: 'decoration',
  floor: 'floor',
