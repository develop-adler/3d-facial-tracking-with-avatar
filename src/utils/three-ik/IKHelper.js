...
class IKHelper extends Object3D {
  ...
  constructor(
    ...
    for (let rootChain of this.ik.chains) {
      ...
      while (chainsToMeshify.length > 0) {
     ...
     * @default true
     */
    this.showBones = showBones === undefined ? true : showBones;
     ...
     * @default true
     */
    this.showAxes = showAxes === undefined ? true : showAxes;
     ...
     * @default true
     */
    this.wireframe = wireframe === undefined ? true : wireframe;
