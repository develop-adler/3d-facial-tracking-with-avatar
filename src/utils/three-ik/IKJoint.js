...
class IKJoint {
  ...
  _worldToLocalDirection(direction) {
    if (this.bone.parent) {
      // getInverse() is deprecated and removed https://github.com/mrdoob/three.js/issues/20572
      // const inverseParent = new Matrix4().getInverse(this.bone.parent.matrixWorld);
      const inverseParent = this.bone.parent.matrixWorld.invert();
  ...
  _applyWorldPosition() {
    ...
    if (parent) {
      ...
      // getInverse() is deprecated and removed https://github.com/mrdoob/three.js/issues/20572
      let inverseParent = this.bone.parent.matrixWorld.invert();
