...
const LeftPanel: FC = () => {
    ...
    const handleHoverStart = (event: PointerEvent<HTMLButtonElement>) => {
        if (hoveringButtonRef.current) {
        ...
        timerRef.current = setTimeout(() => {
            console.log("Hovered for 0.6s!"); // ✅ your function here
        }, 600);
    };
        ...
        <>
            ...
            <Box
                ...
                sx={{
                    ...
                    left: 0,
                    width: PANEL_WIDTH,
                    height: `calc(100vh - ${TOP_MENU_HEIGHT} - var(--lk-control-bar-height) - 6rem)`,
